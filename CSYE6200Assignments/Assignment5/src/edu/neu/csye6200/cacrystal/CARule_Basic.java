 ...
 * @author Dongyue Li
*/
public class CARule_Basic implements CARuleI{
    ...
    /**
     * Basic Rule (tree-like forms, faceted shapes, dendrites forms, needle-like forms, rounded forms)
     * sum of its four neighbors: 0 1 2 3 4 
     * status of itself:          0 1 0 0 0 
     * Each cell on a grid becomes black on the next step if it is already black or
     * whenever exactly one of its neighbors was black on the step before,
     * but stay white whenever it has more than one black neighbor.
...
//        // print heat information
//        for (int i = 0; i < flakeSize; i++) {
//            for (int j = 0; j < flakeSize; j++) {
//                System.out.print("[" + i + ","+ j +"]"+" "+ nextFlake.getCells()[i][j].getHeat() + " ");
//            }
//            System.out.println();
//        }        
