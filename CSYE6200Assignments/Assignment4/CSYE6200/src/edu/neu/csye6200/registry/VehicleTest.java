...
public class VehicleTest {
    ...
    private final Vehicle minivan_gas_3;
    private final Vehicle minivan_gas_4;
    private final Vehicle minivan_gas_5;
    private final Vehicle minivan_gas_6;
    ...
    public VehicleTest() {
        // These 8 cars Info are already in the file. 
        ...
        minivan_gas_3 = new GasVehicle("a.aaa", "0007", "HONDA", "ODYSSEY", 2017, 7, 29850.0, "Gas", 21, 27.0);
        minivan_gas_4 = new GasVehicle("b.bbb", "0008", "HONDA", "ODYSSEY", 2017, 7, 29850.0, "Gas", 21, 27.0);
        minivan_gas_5 = new GasVehicle("c.ccc", "0009", "HONDA", "ODYSSEY", 2017, 7, 29850.0, "Gas", 21, 27.0);
        minivan_gas_6 = new GasVehicle("d.ddd", "0010", "HONDA", "ODYSSEY", 2017, 7, 29850.0, "Gas", 21, 27.0);
...
//        vehicleTaxation = new VehicleTaxation();
        vehicleTaxation = VehicleTaxation.instance();
    ...
    private void run() {
        ...
        vehicleTaxation.addVehicle(minivan_gas_3);
        vehicleTaxation.addVehicle(minivan_gas_4);
        vehicleTaxation.addVehicle(minivan_gas_5);
        vehicleTaxation.addVehicle(minivan_gas_6);
        ...
        // 8. Test Selection Sort Method ASC case-insensitive
        System.out.println("<<<<<<<<<<<<<< 8. Test Selection Sort Method (ASC case-insensitive) >>>>>>>>>>>>>>>>>");
        System.out.println();
        vehicleTaxation.selectionSort(vehicleTaxation.getVehicleList());
        vehicleTaxation.printVehicleTax();
        System.out.println();
        
        // 9. Test Selection Sort Method DESC case-insensitive
        System.out.println("<<<<<<<<<<<<<< 9. Test Collections sort with Comparator (DESC case-insensitive) >>>>>>>>>>>>>>>>>");
        System.out.println();
        Collections.sort(vehicleTaxation.getVehicleList(), vehicleTaxation.myDescComparator);
        vehicleTaxation.printVehicleTax();
    }
